        ...
        <div class="bx-table-scroll">
            <table class="bx-table">
                ...
                <tr class="bx-row {{ $isLeft ? 'bx-row--left' : 'bx-row--right' }}">
                    ...
                    <td>
                        @if($member->_left_user)
                            <span class="bx-slot bx-slot--filled bx-slot--l">
                                <i class="las la-user"></i>{{ $member->_left_user->username }}
                            </span>
                        @else
                            <a href="{{ route('user.distributor.index') }}?parent={{ urlencode($member->username) }}&position=left"
                               class="bx-slot bx-slot--empty" title="Register into {{ $member->username }}'s left slot">
                                <i class="las la-plus"></i> Empty
                            </a>
                        @endif
                    </td>
                    <td>
                        @if($member->_right_user)
                            <span class="bx-slot bx-slot--filled bx-slot--r">
                                <i class="las la-user"></i>{{ $member->_right_user->username }}
                            </span>
                        @else
                            <a href="{{ route('user.distributor.index') }}?parent={{ urlencode($member->username) }}&position=right"
                               class="bx-slot bx-slot--empty" title="Register into {{ $member->username }}'s right slot">
                                <i class="las la-plus"></i> Empty
                            </a>
                        @endif
                    </td>
        ...
        <div class="bx-card {{ $isLeft ? 'bx-card--l' : 'bx-card--r' }}">
            ...
            <div class="bx-card-pv">
                <div class="bx-pv-half">
                    <span class="bx-pv-lbl"><span class="bx-pvdot bx-pvdot--l"></span>Left</span>
                    @if($member->_left_user)
                        <span class="bx-slot bx-slot--filled bx-slot--l">
                            <i class="las la-user"></i>{{ $member->_left_user->username }}
                        </span>
                ...
                <div class="bx-pv-half">
                    <span class="bx-pv-lbl"><span class="bx-pvdot bx-pvdot--r"></span>Right</span>
                    @if($member->_right_user)
                        <span class="bx-slot bx-slot--filled bx-slot--r">
                            <i class="las la-user"></i>{{ $member->_right_user->username }}
                        </span>
