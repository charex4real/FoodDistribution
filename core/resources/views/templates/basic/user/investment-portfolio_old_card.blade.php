                ...
                <div class="kpi-card-body">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div>
                            ...
                            <h2 class="kpi-value kpi-value-danger">{{ showAmount($totalInvestmentValue) }}</h2>
                        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="kpi-card">
                <div class="kpi-card-body">
                    <div class="d-flex align-items-start justify-content-between mb-3">
                        <div>
                            <p class="kpi-label">Shares Balance</p>
                                                    ...
                                                    <div class="d-flex align-items-center gap-3 mb-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="plan-date mb-0 text-muted">
                                                                <i class="fas fa-calendar me-1"></i>{{ $investment->created_at->format('M d, Y') }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="investment-card-actions text-lg-end">
                                                    <div class="mb-3">
                                                        @if($investment->status == 1)
                                                            <span class="badge badge-success-gradient">
...
(function() {
    ...
    function updateTotalAmount() {
        ...
        totalAmount.textContent = price > 0 ? formatNgn(total) : '₦0.00';
    }
    ...
    if (buySharesForm && submitBtn) {
        buySharesForm.addEventListener('submit', function() {
