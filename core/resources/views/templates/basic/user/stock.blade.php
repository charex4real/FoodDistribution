    ...
    <div class="container">
        <div class="row"> 
            <div class="row justify-content-center g-3">
                <div class="row justify-content-right g-3">   
  ...
  <div class="container col-lg-12 col-xl-12 col-xxl-12 px-1 py-4">
    <div class="row align-items-center g-lg-5 py-2">
      <div class="col-lg-7 text-center text-lg-start">
        ...
        <p class="col-lg-10 fs-7 py-2">Welcome to the Stockist centre</p>
      </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                ...
                <div class="product-content">
                    <h6 class="product-title">
                        <a>{{ __(shortDescription($product->name, 35)) }}</a>
                    </h6>
                    @php

                        $store = returnStockist_store($product->id);
                    ...
                    @if($store)  
                        ...
                        @endif
                    @else
                        <span class="product-availablity text--danger">@lang('ORDER')</span>
                    @endif          
                    ...
                    <a class="re_stock cmn--btn-2" stock_id="1" prod_id="{{ $product->id }}" prod_name="{{ $product->name }}" id="reStock" >
                        @if($store) 
                         @lang('RE-stock')
                        @else
                            @lang('Order')
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      <div class="modal-body p-5">
        ...
        <p><strong>Product: </strong><span id="prod_names"></span></p>
    ...
    <script>
        ...
        (function($) {
            ...
            $('.re_stock').on('click', function(e) {
                ...
                let prod_name = $(this).attr('prod_name');
                var stock_id = $(this).attr('stock_id');
              
              //alert(stock_id);

              $('#prod_id').attr('value', prod_id);
              $('#prod_names').html(prod_name);
