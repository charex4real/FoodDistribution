        ...
        @if (!auth()->user()->ts)
            <div class="col-md-6">
                <div class="card custom--card p-0">
                    <div class="card-header bg-success  mb-4 p-3">
                        <h4 class="p-0 m-0 text-white">@lang('Add Your Account')</h4>
                    </div>
        ...
        <div class="col-md-6">
            @if (auth()->user()->ts)
                <div class="card custom--card p-0">
                    ...
                    <form action="{{ route('user.twofactor.disable1') }}" method="POST">
                        <div class="card-body p-4">
                            @csrf
            ...
            @else
                <div class="card custom--card p-0">
                    <div class="card-header bg-success  mb-4 p-3">
                        <h4 class="p-0 m-0 text-white">@lang('Enable 2FA Security')</h4>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('user.twofactor.enable1') }}" method="POST">
                            <div class="card-body">
                                @csrf
                                <input type="hidden" name="key" value="{{ $secret }}">
                                <div class="form--group">
