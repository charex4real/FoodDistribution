...
.wd-blocked-icon { font-size: 3.5rem; color: #dc3545; margin-bottom: 12px; line-height: 1; }
.wd-blocked-title { font-size: 1.35rem; font-weight: 700; color: #a71d2a; margin-bottom: 10px; }
.wd-blocked-msg { color: #555; font-size: 0.95rem; margin-bottom: 16px; }
.wd-blocked-reason {
    background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px;
    padding: 10px 16px; font-size: 0.9rem; color: #664d03; margin-bottom: 16px; text-align: left;
}
.wd-blocked-reason-label { font-weight: 700; margin-right: 6px; }
.wd-blocked-support { font-size: 0.85rem; color: #888; }
.wd-bank-card {
    background: #fff;
    border-radius: 14px;
