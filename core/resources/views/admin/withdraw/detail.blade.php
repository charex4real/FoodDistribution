            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Bank Name')
                            <span class="fw-bold">{{ $withdrawal->user->bname }}</span>
                        </li>

                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Account Name')
                            <span class="fw-bold">{{ $withdrawal->user->aname }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Account Number')
                            <span class="fw-bold">{{ $withdrawal->user->ano }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Click here to view user details')
                            <span class="fw-bold">
                                <a href="{{ route('admin.users.detail', $withdrawal->user_id) }}"><span>@</span>{{ @$withdrawal->user->username }}</a>
                            </span>
                        </li>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    ...
                                    @elseif(@$val->type == 'file')
                                        @if (@$val->value)
                                            <a href="{{ route('admin.download.attachment', encrypt(getFilePath('verify') . '/' . $val->value)) }}"><i
