...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-xl-12">
            <div class="card">
                <form action="{{ route('admin.notices.store') }}" class="notificationForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Recipient username')" name="username" value="{{ old('username') }}" required>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    @if (gs('en'))
                            ...
                            <div class="form-group col-md-12 subject-wrapper">
                                ...
                                <input type="text" class="form-control" placeholder="@lang('Subject / Title')" name="subject" value="{{ old('subject') }}">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="message" rows="10" class="form-control nicEdit">{{ old('message') }}</textarea>
                            </div>
                        </div>
                    </div>

                    <div class="card-footer">
                        <button type="submit" class="btn w-100 h-45 btn--primary">@lang('Send Notice')</button>
                    </div>
                </form>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.notices.index') }}" class="btn btn-sm btn-outline--info">
        <i class="las la-arrow-left"></i> Back to Notices
    </a>
@endpush
