        ...
        <div class="col-lg-12 mb-4">
            <div class="card custom--card p-0">
                ...
                <div class="card-body mb-3 p-4">
                    ...
                    <h4 class="card-title font-weight-normal">@lang('Click To copy')</h4>
                    <form id="copyBoard2">
                        <div class="row align-items-center">
                            <div class="col-md-10 my-1">
                                ...
                                @else
                                <input class="form-control form--control from-control-lg" id="ref2" type="url"
                                    value="{{ route('user.register1') }}?ref={{ auth()->user()->username }}" readonly>
                                @endif
                            </div>
                        ...
                        <table class="custom--table table">
                            <thead>
                                <tr class="bg-success">
                                    ...
                                    <th class="bg-success">@lang('Username')</th>
                                    <th class="bg-success">@lang('Name')</th>
                                    <th class="bg-success">@lang('Email')</th>
                                    <th class="bg-success">@lang('Join Date')</th>
                                </tr>
                            </thead>
                            <tbody>
