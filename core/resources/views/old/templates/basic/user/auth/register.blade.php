                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group hover-input-popup">
                                    ...
                                    <input class="form-control form--control @if (gs('secure_password')) secure-password @endif" name="password"
                                        type="password" required placeholder="Enter Password" id="password">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form--group col-sm-6">
                                    ...
                                    <input type="text" class="form-control form--control" name="state" value="{{ old('state') }}" required>
                                </div>
                        ...
                        @if (gs('agree'))
                            ...
                            <div class="form-group">
                                ...
                                <br/>
                                <a class="text-primary" href="{{ route('agreement') }}" target="_blank">{{ __('Terms of Use and Member Investment Policy') }}</a>
