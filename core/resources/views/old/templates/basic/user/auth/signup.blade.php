                ...
                <div class="account-thumb">
                    ...
                    <div class="account-thumb-content">
                       {{-- <p class="welc">{{ __(@$registerContent->data_values->title) }}</p>
                        ...
                        --}}
                        <h3 class="title">{{ __('Welcome To WiiFarmvest') }}</h3>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-6 col-lg-6">
                <div class="account-form-wrapper @if (!gs('registration')) form-disabled @endif">
                    ...
                    <form class="account-form verify-gcaptcha disableSubmission" method="POST" action="{{ route('user.register2') }}">
                        @csrf
                        <div class="row">
                            @if ($refUser == null)
                                <div class="col-md-12">
                                    <div class="form--group">
                                        <label class="form--label">@lang('Referrer Username')</label>
                                        <input class="referral form-control form--control" id="referenceBy" name="referBy" type="text"
                                            value="{{ old('referBy') }}" placeholder="@lang('Enter referrer username')">
                        ...
                        @if (gs('agree'))
                            ...
                            <div class="form-group">
                                ...
                                <label for="agree">@lang('I agree to the ')<a class="text-primary" href="{{ route('agreement') }}" target="_blank">{{ __('Terms Of Use') }}</a> @lang(' of this cooperative Platform')</label>
                        ...
                        <div class="form--group button-wrapper">
                            ...
                            <a class="custom--btn" href="{{ route('user.login') }}"><span>@lang('Sign In')</span></a>
                        </div>
                    </form>
                </div>
            </div>
