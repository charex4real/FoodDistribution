                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted small mb-4">
                                    You will be redirected to our secure payment gateway to complete your transaction. Your membership will be
                                ...
                                <form action="{{ route('ipn.Paystack1') }}" method="POST" class="text-center">
                                                    ...
                                                    <button id="btn-confirm" class=" btn btn-success btn-lg w-100 mb-3">
                                                        @lang('Pay Now') - {{showAmount($data['amount']/100)}}
                                                    </button>
                                                    <script
                                ...
                                <p class="small text-muted mb-0">By proceeding, you agree to our  <a href="{{ route('agreement') }}" target="_blank">Terms of Use and Member Investment Policy</a></p>
                            </div>
                        </div>
                    </div>
                </div>
