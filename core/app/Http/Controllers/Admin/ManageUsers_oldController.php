...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalDeposit', 'totalWithdrawals', 'totalTransaction', 'totalPinGenerate', 'totalUsedPin', 'countries', 'totalBvCut', 'totalOrder'));
    }
