...
Route::post('paystack1', 'Paystack\ProcessController@ipn1')->name('Paystack1');
Route::post('paystack2', 'Paystack\ProcessController@ipn_webhook')->name('Paystack2');
Route::get('paystack-callback', 'Paystack\ProcessController@callback')->name('PaystackCallback');
Route::post('pp', 'Paystack\ProcessController@pinPayment')->name('pinPay');
...
Route::post('btc-pay', 'BTCPay\ProcessController@ipn')->name('BTCPay');
...
Route::post('checkout', 'Checkout\ProcessController@ipn')->name('Checkout');
